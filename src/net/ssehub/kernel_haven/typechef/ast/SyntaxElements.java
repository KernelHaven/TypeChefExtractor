 ...
 * @author Adam
 */
public enum SyntaxElements implements ISyntaxElement {
    ...
    private static class StaticHelper {
        private static Map<String, SyntaxElements> nameMapping = new HashMap<>();
    }
     ...
     */
    private SyntaxElements(String name) {
        this.name = name;
     ...
     */
    public static SyntaxElements getByName(String name) {

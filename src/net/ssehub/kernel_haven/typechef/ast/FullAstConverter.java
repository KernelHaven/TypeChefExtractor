...
import net.ssehub.kernel_haven.code_model.simple_ast.ISyntaxElementType;
...
public class FullAstConverter implements IAstConverter {
    ...
    static SyntaxElement createSyntaxElement(SyntaxElement parent, Formula condition,
        ...
        if (parent != null) {
            ...
            if (parentPC != True.INSTANCE && !condition.equals(parent.getCondition())) {
                if (condition != True.INSTANCE && !condition.equals(parentPC)) {
